...
import com.jq.ui.print_test.PrinterTestActivity;
import com.jq.ui.print_test.p990display.P990DisplayActivity;
...
public class MainActivity extends Activity {
	...
	private Button mButtonExpressTestBill = null;
	private Button mButtonBtScan = null;
	private Button mButtontModePrint = null;
	private Button mButtonP990Display = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApplication = (DemoApplication)getApplication();  //tip:DemoApplication需要在AndroidManifest.xml的application中注册  android:name="com.jq.ui.DemoApplication"

        mButtonBtScan = (Button)findViewById(R.id.BTButton);        mButtonBtScan.setText("选择打印机");
		...
		mButtonExpressTestBill = (Button)findViewById(R.id.ButtonExpressTestBill);
		mButtonExpressTestBill.setVisibility(Button.INVISIBLE);

		mButtontModePrint  =(Button)findViewById(R.id.ButtontModePrint);
		mButtontModePrint.setVisibility(Button.INVISIBLE);

		mButtonP990Display  =(Button)findViewById(R.id.ButtonP990Display);
		mButtonP990Display.setVisibility(Button.INVISIBLE);
...
//        menu.clear();
    ...
    public void ButtonEnforcement_click(View view)//esc
	{
    ...
    public void ButtonExpress_click(View view)//jlp
	{
    	// Cancel discovery because it will slow down the connection  
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
    ...
    private void setButtonVisible(boolean visible)
    {
        ...
        mButtonExpressTestBill.setVisibility(state);
		mButtontModePrint.setVisibility(state);
		mButtonP990Display.setVisibility(state);
    }
    public void ButtonCardReader_click(View view)//esc
	{
    	// Cancel discovery because it will slow down the connection  
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
    ...
    public void ButtonExpressForm_click(View view)//cpcl
	{
    	// Cancel discovery because it will slow down the connection  
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
	...
	public void ButtonExpressTestBill_click(View view)//test
	{
		// Cancel discovery because it will slow down the connection
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
		...
		Intent myIntent = new Intent(MainActivity.this, MainExpressTestActivity.class);
		startActivity(myIntent);
	}

	public void ButtontModePrint_click(View view)//test
	{
		// Cancel discovery because it will slow down the connection
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
		...
		Intent myIntent = new Intent(MainActivity.this, PrinterTestActivity.class);
		startActivity(myIntent);
	}

	public void ButtontP990Display_click(View view)//test
	{
		// Cancel discovery because it will slow down the connection
		if(btAdapter.isDiscovering())
			btAdapter.cancelDiscovery();
		...
		Intent myIntent = new Intent(MainActivity.this, P990DisplayActivity.class);
		startActivity(myIntent);
	}
