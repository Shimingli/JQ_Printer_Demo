...
public class Barcode extends BaseJPL
{
	 ...
	 * code128
	 */
	public boolean code93(int x,int y, int bar_height, BAR_UNIT unit_width,BAR_ROTATE rotate,String text)
	{
		return _1D_barcode(x,y, BAR_1D_TYPE.CODE93_AUTO,bar_height, unit_width, rotate, text);
	}
	/*
	 * Code128
