...
public class Page  extends BaseJPL
{
	...
	public boolean start(int originX, int originY, int pageWidth, int pageHeight, PAGE_ROTATE rotate) 
	{
		...
		_cmd[4] = 0x01;
		_cmd[5] = (byte)originX;
		_cmd[6] = (byte)(originX>>8);
		_cmd[7] = (byte)originY;
		_cmd[8] = (byte)(originY>>8);
		_cmd[9] = (byte)pageWidth;
		_cmd[10] = (byte)(pageWidth>>8);
		_cmd[11] = (byte)pageHeight;
		_cmd[12] = (byte)(pageHeight>>8);
		_cmd[13] = (byte)rotate.ordinal();
